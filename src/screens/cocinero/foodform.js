...
export default function FoodForm({ route, navigation }) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TextInput style={styles.input} value={nombre} onChangeText={setNombre} placeholder="Ej. Pizza Suprema" />
      ...
      <View style={styles.previewContainer}>
        {imagen ? (
          ...
          <View style={styles.placeholderImg}>
             ...
             <Text style={{ color: '#999', fontSize: 12 }}>Vista previa</Text>
          </View>
        )}
      </View>

      <Text style={styles.label}>Descripción</Text>
      <TextInput style={styles.textarea} value={descripcion} onChangeText={setDescripcion} multiline placeholder="Detalles del plato..." />
...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 14, fontWeight: '600', marginTop: 15, color: '#555' },
  input: { borderWidth: 1, borderColor: '#DDD', borderRadius: 10, padding: 12, marginTop: 6, backgroundColor: '#F9F9F9' },
  ...
  uploadText: { color: '#555', fontWeight: '600' },
  ...
  textarea: { borderWidth: 1, borderColor: '#DDD', borderRadius: 10, padding: 12, marginTop: 6, height: 80, textAlignVertical: 'top', backgroundColor: '#F9F9F9' },
  ...
  cancelButtonText: { color: '#777', fontWeight: 'bold', fontSize: 15 },
});